...
intro_text:
	!text	5,   2, PET_MIDGRAY,	"THE YEAR IS 2525. HUMANS HAVE",0
	!text	3,   3, PET_MIDGRAY,	"SCORCHED THE SKY AND DESTROYED THE",0
	!text	3,   4, PET_MIDGRAY,	"EARTHS SURVACE, MAKING IT ALL BUT",0
	!text	14,  6, PET_WHITE,	"UNINHABITABLE",0
	!text	4,   8, PET_WHITE,	"WHAT'S ",PET_MIDGRAY,"LEFT OF HUMANITY LIVE IN",0
	!text	4,   9, PET_WHITE,	"COLONIES",PET_MIDGRAY," GOVERNED BY THE FEW WHO",0
	!text   4,  10, PET_WHITE,	"WERE",PET_MIDGRAY," ABLE TO GAIN CONTROL OF ALL",0
	!text	11, 12, PET_DARKGRAY,	"REMANING ",PET_WHITE,"ELECTRONICS",0
	!text	3,  14, PET_WHITE,	"IN YOUR COLONY, THE EVIL ",$22,"PROTO TO",$22,0
	!text	6,  15, PET_WHITE,	"RULES MERCILESSLY AND DENIES",0
	!text	5,  16, PET_WHITE,	"ELECTRICITY UNLESS A PUZZLE IS",0
...
+	tay			; Store X coordinate for PLOT function
	...
	cpx	#8		; If Y coordinate is 8, we have just written
